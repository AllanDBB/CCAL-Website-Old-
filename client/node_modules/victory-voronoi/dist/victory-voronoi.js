...
Voronoi.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__.CommonProps.primitiveProps), {}, {
  circleComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  clipId: prop_types__WEBPACK_IMPORTED_MODULE_8___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_8___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string)]),
  clipPathComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  pathComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  polygon: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().array),
  size: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
