...
var getDimensions = function (initialProps, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_8__.modifyProps(initialProps, fallbackProps, "legend");

  var props = lodash_assign__WEBPACK_IMPORTED_MODULE_5___default()({}, modifiedProps, getCalculatedValues(modifiedProps));
...
Border.propTypes = _objectSpread(_objectSpread({}, _victory_util_common_props__WEBPACK_IMPORTED_MODULE_4__.CommonProps.primitiveProps), {}, {
  height: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  rectComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
...
/* harmony import */ var _victory_util_common_props__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../victory-util/common-props */ "../../victory-core/es/victory-util/common-props.js");
...
Point.propTypes = _objectSpread(_objectSpread({}, _victory_util_common_props__WEBPACK_IMPORTED_MODULE_6__.CommonProps.primitiveProps), {}, {
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
  getPath: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().func),
  pathComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  size: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_7___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_7___default().func)]),
  symbol: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOf(["circle", "cross", "diamond", "plus", "minus", "square", "star", "triangleDown", "triangleUp"]), (prop_types__WEBPACK_IMPORTED_MODULE_7___default().func)]),
      ...
      value: function renderContinuousData(props) {
        ...
        var labelComponents = dataKeys.reduce(function (memo, key) {
          ...
          if (labelProps && labelProps.text !== undefined && labelProps.text !== null) {
            newMemo = newMemo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().cloneElement(labelComponent, labelProps));
          }
...
function getScopedEvents(events, namespace, childType, baseProps) {
  ...
  var parseEvent = function (eventReturn, eventKey) {
    ...
    var getMutationObject = function (key, childName) {
      ...
      var mutatedProps = eventReturn.mutation(lodash_assign__WEBPACK_IMPORTED_MODULE_8___default()({}, mutationTargetProps, mutationTargetState), newBaseProps);
...
function getChildBeforeLoad(animate, child, data, cb) {
  var newAnimate = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, animate, {
    onEnd: cb
  });
...
function getChildPropsOnExit(animate, child, data, exitingNodes, cb) {
  ...
  var newAnimate = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, animate, onExit);
...
function getChildPropsBeforeEnter(animate, child, data, enteringNodes, cb) {
  ...
  if (enteringNodes) {
    ...
    newAnimate = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, animate, {
      onEnd: cb
    });
...
function getChildPropsOnEnter(animate, data, enteringNodes, cb) {
  ...
  var newAnimate = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, animate, onEnter);
