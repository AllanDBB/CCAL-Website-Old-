...
var SelectionHelpersClass = /*#__PURE__*/function () {
  function SelectionHelpersClass() {
    ...
    this.onMouseDown = function (evt, targetProps) {
      ...
      var x1 = polar || dimension !== "y" ? x : victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainCoordinates(targetProps).x[0];
      var y1 = polar || dimension !== "x" ? y : victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainCoordinates(targetProps).y[0];
      var x2 = polar || dimension !== "y" ? x : victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainCoordinates(targetProps).x[1];
      var y2 = polar || dimension !== "x" ? y : victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainCoordinates(targetProps).y[1];
      var mutatedProps = {
        x1: x1,
        y1: y1,
        select: true,
    ...
    this.onMouseUp = function (evt, targetProps) {
      ...
      var bounds = victory_core__WEBPACK_IMPORTED_MODULE_6__.getBounds(targetProps);
  ...
  _createClass(SelectionHelpersClass, [{
    ...
    value: function getDatasets(props) {
      ...
      var getData = function (childProps) {
        var data = victory_core__WEBPACK_IMPORTED_MODULE_7__.getData(childProps);
      ...
      var iteratee = function (child, childName, parent) {
        ...
        if (!victory_core__WEBPACK_IMPORTED_MODULE_7__.isDataComponent(child) || lodash_includes__WEBPACK_IMPORTED_MODULE_0___default()(blacklist, childName)) {
          return null;
      ...
      return victory_core__WEBPACK_IMPORTED_MODULE_8__.reduceChildren(react__WEBPACK_IMPORTED_MODULE_5___default().Children.toArray(props.children), iteratee, props);
    }
  }, {
    key: "filterDatasets",
    ...
    value: function getSelectedData(props, dataset) {
      ...
      var withinBounds = function (d) {
        var scaledPoint = victory_core__WEBPACK_IMPORTED_MODULE_8__.scalePoint(props, d);
