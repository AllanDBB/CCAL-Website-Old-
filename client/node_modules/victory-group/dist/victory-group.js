...
function getCalculatedProps(initialProps, childComponents) {
  var role = "group";
  var props = victory_core__WEBPACK_IMPORTED_MODULE_3__.modifyProps(initialProps, fallbackProps, role);
  ...
  var categories = props.categories || victory_core__WEBPACK_IMPORTED_MODULE_4__.getCategories(props, childComponents, null);
  var datasets = props.datasets || victory_core__WEBPACK_IMPORTED_MODULE_4__.getDataFromChildren(props, null);
  var domain = {
...
function getChildren(initialProps, childComponents, calculatedProps) {
  var props = victory_core__WEBPACK_IMPORTED_MODULE_3__.modifyProps(initialProps, fallbackProps, "stack");
  ...
  return children.map(function (child, index) {
    ...
    var style = role === "voronoi" || role === "tooltip" || role === "label" ? child.props.style : victory_core__WEBPACK_IMPORTED_MODULE_4__.getChildStyle(child, index, newCalculatedProps);
...
VictoryGroupBase.propTypes = _objectSpread(_objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_14__.CommonProps.baseProps), victory_core__WEBPACK_IMPORTED_MODULE_14__.CommonProps.dataProps), {}, {
  ...
  offset: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().number)
});
var componentConfig = {
  role: "group",
...
var VictoryGroup = Object.assign( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().memo(VictoryGroupBase, (react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default())), componentConfig);
