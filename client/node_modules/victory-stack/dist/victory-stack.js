...
function getCalculatedProps(initialProps, childComponents) {
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(initialProps.children);
  var role = "stack";
  var props = victory_core__WEBPACK_IMPORTED_MODULE_6__.modifyProps(initialProps, fallbackProps, role);
  var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.getStyle(props.theme, props.style, role);
  var categories = props.categories || victory_core__WEBPACK_IMPORTED_MODULE_5__.getCategories(props, children);
...
var withoutSharedEvents = function (props) {
  ...
  var modifiedChildren = react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(children).map(function (_child) {
    var child = _child;
...
function getChildren(initialProps, childComponents, calculatedProps) {
  var props = victory_core__WEBPACK_IMPORTED_MODULE_6__.modifyProps(initialProps, fallbackProps, "stack");
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(props.children);
  ...
  return children.map(function (child, index) {
    ...
    var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.getChildStyle(child, index, newCalculatedProps);
...
/* harmony import */ var lodash_assign__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/assign */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/assign.js");
/* harmony import */ var lodash_assign__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_assign__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! prop-types */ "../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/hooks/use-animation-state.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/wrapper.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/hooks/use-previous-props.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/common-props.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/prop-types.js");
/* harmony import */ var victory_shared_events__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! victory-shared-events */ "../../victory-shared-events/es/victory-shared-events.js");
...
var defaultProps = {
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer, null),
...
var VictoryStackBase = function (initialProps) {
  ...
  var propsWithDefaults = react__WEBPACK_IMPORTED_MODULE_3___default().useMemo(function () {
    return _objectSpread(_objectSpread({}, defaultProps), initialProps);
  }, [initialProps]);

  var _Hooks$useAnimationSt = victory_core__WEBPACK_IMPORTED_MODULE_7__.useAnimationState(),
  ...
  var calculatedProps = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_9__.useMemoizedProps)(modifiedProps);
  var domain = calculatedProps.domain,
      scale = calculatedProps.scale,
      style = calculatedProps.style;
  var newChildren = react__WEBPACK_IMPORTED_MODULE_3___default().useMemo(function () {
    var children = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_9__.getChildren)(props, childComponents, calculatedProps);
  ...
  var userProps = react__WEBPACK_IMPORTED_MODULE_3___default().useMemo(function () {
    return victory_core__WEBPACK_IMPORTED_MODULE_10__.getSafeUserProps(propsWithDefaults);
  }, [propsWithDefaults]);
  ...
  var events = react__WEBPACK_IMPORTED_MODULE_3___default().useMemo(function () {
    return victory_core__WEBPACK_IMPORTED_MODULE_11__.getAllEvents(props);
  }, [props]);
  var previousProps = victory_core__WEBPACK_IMPORTED_MODULE_12__.usePreviousProps(propsWithDefaults);
  react__WEBPACK_IMPORTED_MODULE_3___default().useEffect(function () {
  ...
  if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(events)) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_shared_events__WEBPACK_IMPORTED_MODULE_13__.VictorySharedEvents, {
      container: container,
      eventKey: eventKey,
      events: events,
...
VictoryStackBase.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_14__.CommonProps.baseProps), {}, {
  bins: prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_15___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_16__.nonNegative, prop_types__WEBPACK_IMPORTED_MODULE_15___default().instanceOf(Date)])), victory_core__WEBPACK_IMPORTED_MODULE_16__.nonNegative]),
  categories: prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_15___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_15___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_15___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_15___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_15___default().string)),
    y: prop_types__WEBPACK_IMPORTED_MODULE_15___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_15___default().string))
  })]),
  children: prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_15___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_15___default().node)), (prop_types__WEBPACK_IMPORTED_MODULE_15___default().node)]),
  colorScale: prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_15___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_15___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOf(["grayscale", "qualitative", "heatmap", "warm", "cool", "red", "green", "blue"])]),
  fillInMissingData: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().bool),
  horizontal: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().bool),
  labelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().element),
  labels: prop_types__WEBPACK_IMPORTED_MODULE_15___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_15___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_15___default().array)]),
  style: prop_types__WEBPACK_IMPORTED_MODULE_15___default().shape({
    parent: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().object),
    data: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().object),
    labels: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().object)
  }),
  xOffset: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().number)
});
var componentConfig = {
  role: "stack",
  expectedComponents: ["groupComponent", "containerComponent", "labelComponent"],
  getChildren: _helper_methods__WEBPACK_IMPORTED_MODULE_9__.getChildren
};
var VictoryStack = Object.assign( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().memo(VictoryStackBase, (react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default())), componentConfig);
...
function findAxisComponents(childComponents, predicate) {
  var predicateFunction = predicate || (lodash_identity__WEBPACK_IMPORTED_MODULE_9___default());
...
function getDataFromChildren(props, childComponents) {
  ...
  var iteratee = function (child, childName, parent) {
    ...
    if (!_data__WEBPACK_IMPORTED_MODULE_12__.isDataComponent(child)) {
      ...
      childElement = parent ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().cloneElement(child, parent.props) : child;
...
function getData(props, childComponents) {
  ...
  return getDataFromChildren(props, childComponents || react__WEBPACK_IMPORTED_MODULE_9___default().Children.toArray(props.children));
}
...
function getDomain(props, axis, childComponents) {
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_9___default().Children.toArray(props.children);
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/timer-context.js");
...
VictorySharedEvents.contextType = victory_core__WEBPACK_IMPORTED_MODULE_12__["default"];
