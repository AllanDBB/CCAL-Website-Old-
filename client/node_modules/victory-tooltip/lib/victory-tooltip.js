...
var VictoryTooltip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryTooltip, [{
    ...
    value: function getPolarOrientation(props) {
      var degrees = _victoryCore.LabelHelpers.getDegrees(props, props.datum);
    ...
    value: function getEvaluatedProps(props) {
      ...
      var offsetX = (0, _isPlainObject2.default)(centerOffset) && (centerOffset === null || centerOffset === void 0 ? void 0 : centerOffset.x) !== undefined ? _victoryCore.Helpers.evaluateProp(centerOffset.x, evaluatedProps) : 0;
      var offsetY = (0, _isPlainObject2.default)(centerOffset) && (centerOffset === null || centerOffset === void 0 ? void 0 : centerOffset.y) !== undefined ? _victoryCore.Helpers.evaluateProp(centerOffset.y, evaluatedProps) : 0;
