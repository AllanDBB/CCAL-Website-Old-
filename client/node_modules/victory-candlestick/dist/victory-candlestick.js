...
var defaultProps = {
  ...
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.Line, null),
  rectComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.Rect, null),
  role: "presentation",
  shapeRendering: "auto"
};
var Candle = function (props) {
  ...
  var candleProps = lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()(getCandleProps(modifiedProps, style), sharedProps);

  var highWickProps = lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()(getHighWickProps(modifiedProps, wickStyle), sharedProps);

  var lowWickProps = lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()(getLowWickProps(modifiedProps, wickStyle), sharedProps);
...
var getBaseProps = function (initialProps, fallbackProps) {
  ...
  var props = victory_core__WEBPACK_IMPORTED_MODULE_7__.modifyProps(initialProps, fallbackProps, "candlestick");
  ...
  return data.reduce(function (childProps, datum, index) {
    ...
    if (labels) {
      var text = victory_core__WEBPACK_IMPORTED_MODULE_10__.getText(props, formattedDatum, index);
