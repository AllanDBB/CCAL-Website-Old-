...
var defaultProps = {
  pathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_4__.Path, null),
  role: "presentation",
  shapeRendering: "auto"
};
...
Flyout.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__.CommonProps.primitiveProps), {}, {
  center: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
    x: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
    y: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number)
  }),
  cornerRadius: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
  dx: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
  dy: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
  ...
  pointerLength: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
  pointerWidth: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
