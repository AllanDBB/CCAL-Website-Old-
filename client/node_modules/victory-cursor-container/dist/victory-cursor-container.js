...
LineSegment.propTypes = _objectSpread(_objectSpread({}, _victory_util_common_props__WEBPACK_IMPORTED_MODULE_4__.CommonProps.primitiveProps), {}, {
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().any),
  lineComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
  x1: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  x2: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  y1: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  y2: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)
});
