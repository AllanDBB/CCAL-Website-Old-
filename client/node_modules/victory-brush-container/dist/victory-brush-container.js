...
var Helpers = {
  ...
  getDomainBox: function (props, fullDomain, selectedDomain) {
    ...
    var fullCoords = victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainCoordinates(props, fullDomainObject);
    var selectedCoords = victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainCoordinates(props, selectedDomainObject);
    return {
    ...
    _createClass(VictoryBrushContainer, [{
      ...
      value: function getHandles(props, domain) {
        ...
        var handles = ["top", "bottom", "left", "right"].reduce(function (memo, curr) {
          return handleProps[curr] ? memo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(handleComponent, lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({
